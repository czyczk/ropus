// Pre-computed mixing/demixing matrices for ambisonics projection.
// Ported verbatim from reference/src/mapping_matrix.c (xiph/opus).
// Coefficients are Q15 fixed-point; column-major storage matches the C layout.
// Consumed by `get_mixing_matrix_for_order` / `get_demixing_matrix_for_order`
// in `ropus/src/opus/multistream.rs`.

#[rustfmt::skip]
static FOA_MIXING_DATA: [i16; 36] = [
...
#[rustfmt::skip]
static FOA_DEMIXING_DATA: [i16; 36] = [
...
#[rustfmt::skip]
static SOA_MIXING_DATA: [i16; 121] = [
...
#[rustfmt::skip]
static SOA_DEMIXING_DATA: [i16; 121] = [
...
#[rustfmt::skip]
static TOA_MIXING_DATA: [i16; 324] = [
...
#[rustfmt::skip]
static TOA_DEMIXING_DATA: [i16; 324] = [
...
#[rustfmt::skip]
static FOURTHOA_MIXING_DATA: [i16; 729] = [
...
#[rustfmt::skip]
static FOURTHOA_DEMIXING_DATA: [i16; 729] = [
...
#[rustfmt::skip]
static FIFTHOA_MIXING_DATA: [i16; 1444] = [
      9243,      0,  16010,      0,      0,      0,  20669,      0,
         0,      0,      0,      0,  24456,      0,      0,      0,
         0,      0,      0,      0,  27731,      0,      0,      0,
         0,      0,      0,      0,      0,      0,  30657,      0,
...
#[rustfmt::skip]
static FIFTHOA_DEMIXING_DATA: [i16; 1444] = [
